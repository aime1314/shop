var pwdBox = PwdBox = {
    template: '<style>.flexable{display: -webkit-box;} .flexable>div{-webkit-box-flex: 1;} .flexable.password>div{opacity: 0};.flexable.password>div.active{opacity: 1 !important;}.password{ margin: 60px 70px 30px 69px;}.password>div{height:100px;line-height:100px;text-align:center}.password>div:first-child{border-top-left-radius:5px;border-bottom-left-radius:5px}.password>div:last-child{border-top-right-radius:5px;border-bottom-right-radius:5px}.input-box .flexable>div{height:97px}.input-box .flexable>div:active{background:rgba(0,200,200,.5)}.list-block .item-title{font-weight:normal!important;font-size:14px}ul li{position:relative}.close{position:absolute;top:12px;left:21px;font-size:72px;color:#989EAB;width:35px;text-align:center} h1.title{height:50px;font-size:30px;line-height:50px;text-align:center;margin: 0;} .notice{height:30px;line-height:30px;font-size:30px;text-align:center;margin-bottom:38px;color: #3E8CF9;}</style>' + '<div class="password-box" style="position: fixed;top:0;left:0;z-index: 100;width: 100%;height: 100%;background: rgba(0,0,0,.7);display:none;">' + '<div class="inner-box" style="position: fixed;bottom: 0;left: 0;width: 100%;height: 380px;background: url(../images/pwd_keyboard.png) center bottom / 100% 100%;">' + '<span class="iconfont icon-guanbi close">×</span>' + '<h1 class="title">支付密码</h1>' + '<div class="flexable password">' + '<div >●</div>' + '<div >●</div>' + '<div >●</div>' + '<div >●</div>' + '<div >●</div>' + '<div >●</div>' + '<!--●-->' + '</div>' + '<div class="notice color-lightblue">请输入支付密码！</div>' + '<div class="input-box">' + '<div class="flexable">' + '<div class="input-key" data-label="1" ></div><div class="input-key" data-label="2"></div><div class="input-key"  data-label="3"></div>' + '</div>' + '<div class="flexable">' + '<div class="input-key" data-label="4" ></div><div class="input-key" data-label="5"></div><div class="input-key" data-label="6"></div>' + '</div>' + '<div class="flexable">' + '<div class="input-key" data-label="7" ></div><div class="input-key" data-label="8"></div><div class="input-key" data-label="9"></div>' + '</div>' + '<div class="flexable">' + '<div></div><div class="input-key" data-label="0" ></div><div class="input-key" data-label="del"  ></div>' + '</div>' + '</div>' + '</div>' + '</div>',
    passwordOrg: '',
    password: '',
    inited: false,
