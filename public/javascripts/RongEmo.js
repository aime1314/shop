// import groupDb from "./groupDataBase";
...
function emjo() {
    ...
    function unicodeToEmoji(content, reg) {
        // console.log("unicodeToEmoji:  ",content);
        reg = reg || Config.reg;
    ...
    function calculateUTF(char) {
        ...
        // console.log("calculateUTF_RongFromCodePoint:  ",unicodes);
        // console.log("calculateUTF_RongFromCodePoint:  ",String.RongFromCodePoint);
        var b = RongFromCodePoint(unicodes);
        // console.log("calculateUTF_RongFromCodePoint:  ",b);
        return b;
    }
    ...
    function RongFromCodePoint (codeList) {
